...
const page = () => {
  return (
    <div className="">
      ...
      <div
        className="p-10 leading-8 
      text-lg mt-10 relative m-auto rounded-lg text-center"
      >
        <h1
          className="text-4xl font-extrabold w-full text-center uppercase 
text-primary mb-10"
        >
          Let's Discuss
        </h1>
        ...
        >
          <div className="flex gap-5 max-sm:flex-col">
            <input
              type="text"
              placeholder="Name"
              className="px-1 py-3 border-gray-300 w-full rounded-md text-gray-900
